...
/**
 * Servlet implementation class UpdateListingStatusServlet
 */
public class UpdateListingStatusServlet extends HttpServlet {
	...
	public void service(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
	{
		try
		{
			...
			String jobID = req.getParameter("statusJobID");
			...
			int status = m.changeJobStatus(jobID);
